...
architecture. The input of the network is a concatenation of the RGB image with 
different optical flow configurations. The performance is evaluated using the 
