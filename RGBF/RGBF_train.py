...
This network concatenates different optical flow configurations with a 
RGB Image. For example, RGBM means concatenating RGB image with the optical
flow magnitude resulting in a 4D tensor (N, 4, H, W).
