...
This script is used to evaluate the performance of the 2-stream U-Net encoder-decoder 
network architecture. The performance is evaluated using the Intersection over Union (IoU)
metric. 
...
# Load the model
gatenet 		= 'CyberZoo/CZ_FusionRGBM_K1'
